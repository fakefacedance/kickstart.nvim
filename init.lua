...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>?', builtin.oldfiles, { desc = 'Sejrch Recent Files' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'php', 'phpdoc', 'javascript', 'typescript', 'bash', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'yaml', 'dockerfile' },
